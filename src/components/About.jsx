  ...
  return (
    <>
      <div className='relative overflow-hidden lg:overflow-visible'>
        ...
        >
          "Dedicated full-stack web developer with a strong foundation in React, Next.js, Three.js, and Express.js. 
          Proficient in JavaScript, APIs, and database management (PostgreSQL). 
          Passionate about competitive programming and have a solid understanding of core computer science concepts."
        </motion.p>
